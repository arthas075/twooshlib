...
//        mProgressView = findViewById(R.id.login_progress);
    ...
    public void signupAPI(final JSONObject signupobj){
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if((publishtwoosh_resp.get("status").equals("Success")) && ((inserted.equals("1")) || (otp_verified.equals("0")))){
                        ...
                        Toast.makeText(Signup.this, "In else part", Toast.LENGTH_SHORT).show();
                    }
    ...
    public void startVerifyOTP(String mobile){


        Intent i = new Intent(Signup.this, VerifyOTP.class);
        i.putExtra("mobile",mobile);
        i.putExtra("pwd",pwd_pass);
        startActivity(i);


    }

    boolean sanitizeSignup(){
